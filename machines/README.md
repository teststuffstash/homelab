...
| wk-metal-02 | k8s control plane (ADR-133 — one CP per chassis, laptop battery = a UPS for etcd) | Lenovo ThinkPad X250 | 4 | 8 | laptop4 | — | — | — | — | — | — |
...
| nx-01 | k8s worker, RIDE/ARC tier (tainted; kata node, EPHEMERAL on NVMe) — Longhorn SCRATCH only (`fast`) | Supermicro X10DRT-P-G5-NI22 (Nutanix NX-6035-G5, CSE-827HD+ 2U twin), 2 × Xeon E5-2640 v4 | 40 | 64 | — | — | — | — | — | — | IPMI/BMC — the fleet's FIRST (ADR-013 assumed none): `ipmitool -I lanplus -H 192.168.2.123 -U ADMIN -P ADMIN chassis power on\|off\|cycle`. No WoL or smart plug needed. |
