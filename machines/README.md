...
| thinkcentre | k8s worker + Longhorn (+ 2×Optane fast tier) | Lenovo ThinkCentre Edge | 2 | 4 | konditsioneer | 27.9 | 54.5 | 1200.4 | 2231.7 | 40.9 | smart-plug (switch.konditsioneer_socket); auto-boots on AC restore — NOT WoL |
| hp-01 | k8s worker + Longhorn (WoL-capable) | HP desktop | — | 8 | — | — | — | — | — | — | Wake-on-LAN (PXE-booted; no smart plug) |
