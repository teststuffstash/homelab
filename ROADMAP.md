...
| S3 | belts & lint upkeep: transport-lint signatures (in flight), ratchet unreplayed backfill (sentinel pushgateway blind DONE 2026-08-19 — FU-176 archived) | homelab#564, the FSM `unreplayed` rows |
