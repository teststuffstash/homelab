...
| [The management box](docs/management-box.md) (`thinkcentre`) | R12 out-of-band applier — no workloads, no storage (ADR-129) | 🔜 pilot installed 2026-09-13 (`docs/management-box.md` docs/spikes/model-routing-history.md §MB1); its test surface is the main root's raw-k8s residue, kept in tofu for it (operator, 2026-09-13) — then Renovate through the box (G-D), then the ArgoCD migration + the second OPNsense / third CP for it to operate on |
