...
variable "protected_repos" {
  ...
  default = {
    ...
    snore-recorder      = { required_checks = ["ci", "mgmt-sentinel-dummy"] }                                                     # DUMMY — never merge: tests the box's github plan verdict (#1629)                                                                          # PR `ci` check confirmed live 2026-07-24 (PR #8 era runs)
