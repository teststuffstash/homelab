...
| `fast` | **nx-01 `intel7600p`** since 2026-09-24 (replica-1 ride scratch only; the Optane pair is shelved, FU-234) | 238G | 238G | 0 | 5G (2%) *(re-read 2026-09-24)* |
...
3. **The `fast` tier had zero consumers**, so losing both Optanes with the box cost nothing
   (FU-159's scratch-only ruling is why it was empty). The tier was re-homed on nx-01's 7600p
   instead (2026-09-24), and the Optanes stay shelved: 16 GB each fits no 20Gi ride claim (FU-234).
...
| **`fast` big enough to be the scratch tier** (replica-1) | **MET 2026-09-24**: nx-01's 7600p (238 G) took the tag. The Optane pair (16 GB each, ~13 G usable) is shelved, since no 20Gi ride claim fits one (FU-234) | FU-159 ruling: `fast` = scratch for disk-write-heavy pods, never load-bearing data; it was unused at 1.4 G because nothing fits, which is what made retiring its host node safe | want | FU-234, FU-159 |
