...
| **MP-T04** | re-review after changes-requested + new content | review reflex (same predicate, reviewable_again arm) | guarded | ✅ new CONTENT since verdict (non-merge commits only, via newest_commit_at) (`homelab:agents/review-reflex.sh`) | — | 2026-07-09 oracle-fleet#6 (the BEHIND-re-review exception's origin) |
