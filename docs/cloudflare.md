...
| First consumers — the apex `consumer` claim (oracle-iac, 2026-08-12 → v1alpha2 #531; static site behind it 2026-09-03) and the `mcp.minutark.ee` `api` claim (oracle-iac#532, public 21:28Z 2026-09-03). The live checks (homelab#1334): 1 api 429 ✅ observed 21:30Z (97×429, JSON body, `Retry-After: 10`, no interstitial in 300 responses), 2 consumer cache ✅ observed 12:35Z, 3 RUM ✗ undeliverable via any user token (design residual, #1311) | ✅ 1+2 / ✗ 3 |
