...
- **Per-stack subdomain delegation** (ADR-092): a stack that opts in gets ONE VIP pair for its
  ...
  Assigned so far: **oracle** `3.22 ↔ 40.22`, **sleep** `3.26 ↔ 40.26`, **circles** `3.28 ↔ 40.28`; plain LB (no HAProxy pair): `40.29` otel-collector LAN OTLP (jail telemetry, 2026-08-08)
