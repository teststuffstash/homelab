...
# Source touches-check.sh which contains fp_norm_entry, fp_pair_conflict, fp_conflict (the core
# prefix-intersection logic). The same helper is sourced by reviewer-session.sh for computing
# escape sets — zero drift, two callers, one logic home (homelab#379).
