...
| fixture | mode | source | pinned by (FSM) |
|---|---|---|---|
...
| `c4c5-infeasible-parks` | actions | `agents/coordinator-scan.sh` | IL-T06 IL-T26 |
| `c4c5-infeasible-probe-fail` | actions | `agents/coordinator-scan.sh` | IL-T06 IL-T26 |
| `c4c5-infeasible-quoted-inert` | actions | `agents/coordinator-scan.sh` | IL-T06 IL-T26 |
| `ci-red-rounds-two-channels` | actions | `agents/coordinator-scan.sh` | MP-T12 |
...
| `harvest-goal-closed` | actions | `agents/coordinator-scan.sh` | IL-T15 |
| `harvest-goal-open-exhausted` | actions | `agents/coordinator-scan.sh` | IL-T15 IL-T17 |
| `harvest-goal-open-funded` | actions | `agents/coordinator-scan.sh` | IL-T15 IL-T17 |
