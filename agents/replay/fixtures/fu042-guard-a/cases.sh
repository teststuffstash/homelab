# ── the four arms ── each overrides PF_ISSUE / WORK_BRANCH so the SAME recorded world answers all
# four shapes. The refusal arms run in a subshell because fu042_guard_a EXITS 3; the rc is printed
