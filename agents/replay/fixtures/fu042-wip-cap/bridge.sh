...
#
# World: one Running pod + one Pending Unschedulable old pod. With WIP=2, the count of 1
# (wedged pod excluded) passes — demonstrating that a wedged pod does NOT hold a WIP slot.
