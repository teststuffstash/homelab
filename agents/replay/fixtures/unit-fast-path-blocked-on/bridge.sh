...
# (cluster-merged in production); HERE anchors the latch/session scripts the dispatching legs
# reach, which are recording stubs in this directory. REPO_MAX_WIP is the scan's own default
# (top of the file) — the fast path compares flive against it.
HERE="$REPLAY_FIXTURE"
KUBECTL=kubectl
KUBE=""
