...
add_secret cloudflare-mgmt-read          "$(file_or "$HOME/.claude/cloudflare/mgmt-read" REPLACE)"   # the management box's read-only tofu/cloudflare token (mgmt-read.tf, FU-238)
