...
class=fix ride to the haiku subscription rail on it (docs/agents/model-routing-history.md §M12).
...
#                             (agents/agent-session.sh, docs/agents/model-routing-history.md §M12).
...
class Proxy(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        ...
        if self.path == "/route":
            ...
            # only after a soak review reads them (docs/agents/model-routing-history.md §M11).
